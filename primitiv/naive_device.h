...
private:
  ...
  void pown_fw_impl(const Tensor &x, int32_t k, Tensor &y) override;
  ...
  void pown_bw_impl(const Tensor &x, const Tensor &y, const Tensor &gy, int32_t k, Tensor &gx) override;
