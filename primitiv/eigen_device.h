...
private:
  ...
  void pown_fw_impl(const Tensor &x, std::int32_t k, Tensor &y) override { THROW_ERROR("Not implemented."); }
  ...
  void pown_bw_impl(const Tensor &x, const Tensor &y, const Tensor &gy, std::int32_t k, Tensor &gx) override { THROW_ERROR("Not implemented."); }
