...
void safe_primitiv_SGD_delete(primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_SGD_eta(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
void primitiv_SGD_get_configs(
  ...
  CAST_TO_CONST_CC_SGD(optimizer)->get_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_SGD_get_configs(
  ...
  SAFE_EXPR(primitiv_SGD_get_configs(optimizer, uint_configs, float_configs), status);
}
...
void primitiv_SGD_set_configs(
  ...
  CAST_TO_CC_SGD(optimizer)->set_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_SGD_set_configs(
    ...
    const primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_SGD_set_configs(optimizer, uint_configs, float_configs), status);
}

primitiv_Optimizer *primitiv_MomentumSGD_new(float eta, float momentum) {
  return to_c(new MomentumSGD(eta, momentum));
}
primitiv_Optimizer *safe_primitiv_MomentumSGD_new(float eta, float momentum, primitiv_Status *status) {
...
void safe_primitiv_MomentumSGD_delete(primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_MomentumSGD_eta(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_MomentumSGD_momentum(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
void primitiv_MomentumSGD_get_configs(
    ...
    primitiv_StrIntMap *uint_configs,
    primitiv_StrFloatMap *float_configs) {
  CAST_TO_CONST_CC_MOMENTUM_SGD(optimizer)->get_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_MomentumSGD_get_configs(
    ...
    primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_MomentumSGD_get_configs(optimizer, uint_configs, float_configs), status);
}
...
void primitiv_MomentumSGD_set_configs(
    ...
    const primitiv_StrIntMap *uint_configs,
    const primitiv_StrFloatMap *float_configs) {
  CAST_TO_CC_MOMENTUM_SGD(optimizer)->set_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_MomentumSGD_set_configs(
    ...
    const primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_MomentumSGD_set_configs(optimizer, uint_configs, float_configs), status);
}

primitiv_Optimizer *primitiv_AdaGrad_new(float eta, float eps) {
  return to_c(new AdaGrad(eta, eps));
}
primitiv_Optimizer *safe_primitiv_AdaGrad_new(float eta, float eps, primitiv_Status *status) {
...
void safe_primitiv_AdaGrad_delete(primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_AdaGrad_eta(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_AdaGrad_eps(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
void primitiv_AdaGrad_get_configs(
    ...
    primitiv_StrIntMap *uint_configs,
    primitiv_StrFloatMap *float_configs) {
  CAST_TO_CONST_CC_ADA_GRAD(optimizer)->get_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_AdaGrad_get_configs(
    ...
    primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_AdaGrad_get_configs(optimizer, uint_configs, float_configs), status);
}
...
void primitiv_AdaGrad_set_configs(
    ...
    const primitiv_StrIntMap *uint_configs,
    const primitiv_StrFloatMap *float_configs) {
  CAST_TO_CC_ADA_GRAD(optimizer)->set_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_AdaGrad_set_configs(
    ...
    const primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_AdaGrad_set_configs(optimizer, uint_configs, float_configs), status);
}

primitiv_Optimizer *primitiv_RMSProp_new(float eta, float alpha, float eps) {
  return to_c(new RMSProp(eta, alpha, eps));
}
primitiv_Optimizer *safe_primitiv_RMSProp_new(float eta, float alpha, float eps, primitiv_Status *status) {
...
void safe_primitiv_RMSProp_delete(primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_RMSProp_eta(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_RMSProp_alpha(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_RMSProp_eps(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
void primitiv_RMSProp_get_configs(
    ...
    primitiv_StrIntMap *uint_configs,
    primitiv_StrFloatMap *float_configs) {
  CAST_TO_CONST_CC_RMS_PROP(optimizer)->get_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_RMSProp_get_configs(
    ...
    primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_RMSProp_get_configs(optimizer, uint_configs, float_configs), status);
}
...
void primitiv_RMSProp_set_configs(
    ...
    const primitiv_StrIntMap *uint_configs,
    const primitiv_StrFloatMap *float_configs) {
  CAST_TO_CC_RMS_PROP(optimizer)->set_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_RMSProp_set_configs(
    ...
    const primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_RMSProp_set_configs(optimizer, uint_configs, float_configs), status);
}

primitiv_Optimizer *primitiv_AdaDelta_new(float rho, float eps) {
  return to_c(new AdaDelta(rho, eps));
}
primitiv_Optimizer *safe_primitiv_AdaDelta_new(float rho, float eps, primitiv_Status *status) {
...
void safe_primitiv_AdaDelta_delete(primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_AdaDelta_rho(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_AdaDelta_eps(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
void primitiv_AdaDelta_get_configs(
    ...
    primitiv_StrIntMap *uint_configs,
    primitiv_StrFloatMap *float_configs) {
  CAST_TO_CONST_CC_ADA_DELTA(optimizer)->get_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_AdaDelta_get_configs(
    ...
    primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_AdaDelta_get_configs(optimizer, uint_configs, float_configs), status);
}
...
void primitiv_AdaDelta_set_configs(
    ...
    const primitiv_StrIntMap *uint_configs,
    const primitiv_StrFloatMap *float_configs) {
  CAST_TO_CC_ADA_DELTA(optimizer)->set_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_AdaDelta_set_configs(
    ...
    const primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_AdaDelta_set_configs(optimizer, uint_configs, float_configs), status);
}

primitiv_Optimizer *primitiv_Adam_new(float alpha, float beta1, float beta2, float eps) {
  return to_c(new Adam(alpha, beta1, beta2, eps));
}
primitiv_Optimizer *safe_primitiv_Adam_new(float alpha, float beta1, float beta2, float eps, primitiv_Status *status) {
...
void safe_primitiv_Adam_delete(primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_Adam_alpha(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_Adam_beta1(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_Adam_beta2(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
float safe_primitiv_Adam_eps(const primitiv_Optimizer *optimizer, primitiv_Status *status) {
...
void primitiv_Adam_get_configs(
    ...
    primitiv_StrIntMap *uint_configs,
    primitiv_StrFloatMap *float_configs) {
  CAST_TO_CONST_CC_ADAM(optimizer)->get_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_Adam_get_configs(
    ...
    primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_Adam_get_configs(optimizer, uint_configs, float_configs), status);
}
...
void primitiv_Adam_set_configs(
    ...
    const primitiv_StrIntMap *uint_configs,
    const primitiv_StrFloatMap *float_configs) {
  CAST_TO_CC_ADAM(optimizer)->set_configs(*to_cc(uint_configs), *to_cc(float_configs));
}
void safe_primitiv_Adam_set_configs(
    ...
    const primitiv_StrFloatMap *float_configs,
    primitiv_Status *status) {
  SAFE_EXPR(primitiv_Adam_set_configs(optimizer, uint_configs, float_configs), status);
}
