...
class LSTM(object):
    ...
    def __init__(self, name, in_size, out_size, trainer):
        ...
        self.pwxh_ = Parameter(name + ".wxh", [4 * out_size, in_size], I.Uniform(-0.1, 0.1))
        self.pwhh_ = Parameter(name + ".whh", [4 * out_size, out_size], I.Uniform(-0.1, 0.1))
        self.pbh_ = Parameter(name + ".bh", [4 * out_size], I.Constant(0))
...
class RNNLM(object):
    ...
    def __init__(self, vocab_size, eos_id, trainer):
        ...
        self.rnn1_ = LSTM("rnn1", NUM_HIDDEN_UNITS, NUM_HIDDEN_UNITS, trainer)
        self.rnn2_ = LSTM("rnn2", NUM_HIDDEN_UNITS, NUM_HIDDEN_UNITS, trainer)
