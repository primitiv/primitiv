...
docker exec travis-ci bash -c "apt install -y build-essential cmake git libprotobuf-dev protobuf-compiler googletest python3-dev python3-pip python3-numpy"
