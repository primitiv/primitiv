...
TEST_F(CGraphTest, CheckClear) {
...

  {
    ...
    ::primitivNodeInput(shape, values, 1, nullptr, nullptr, &node1);
    ::primitivDeleteNode(node1);
    ::primitivNode_t *node2;
    ::primitivNodeInput(shape, values, 1, nullptr, nullptr, &node2);
...

  {
    ...
    float values[] = {1};
    ::primitivNode_t *node;
    ::primitivNodeInput(shape, values, 1, nullptr, nullptr, &node);
    ::primitivDeleteNode(node);
    ::primitivNodeInput(shape, values, 1, nullptr, nullptr, &node);
    ::primitivDeleteNode(node);
    ::primitivNodeInput(shape, values, 1, nullptr, nullptr, &node);
...
TEST_F(CGraphTest, CheckForward) {
  ...
  ::primitivNode_t *node1;
  ::primitivNodeInput(shape1, data1, 12, nullptr, nullptr, &node1);
  nodes.emplace_back(node1);
  ::primitivShape_t *shape2;
  ASSERT_EQ(PRIMITIV_C_OK,
            ::primitivCreateShapeWithDims(dims1, 2, 1, &shape2));
  ::primitivNode_t *node2;
  ::primitivNodeOnes(shape2, nullptr, nullptr, &node2);
  nodes.emplace_back(node2);
  ::primitivNode_t *node3;
  ::primitivNodeInput(shape1, data3, 12, nullptr, nullptr, &node3);
  nodes.emplace_back(node3);
  ::primitivNode_t *node4;
  ::primitivNodeAddNodeNode(nodes[0], nodes[1], &node4);
  nodes.emplace_back(node4);
  ::primitivNode_t *node5;
  ::primitivNodeSubtractNodeNode(nodes[1], nodes[2], &node5);
  nodes.emplace_back(node5);
  ::primitivNode_t *node6;
  ::primitivNodeMultiplyNodeNode(nodes[3], nodes[4], &node6);
  nodes.emplace_back(node6);
  ::primitivNode_t *node7;
  ::primitivNodeAddNodeConst(nodes[5], 1, &node7);
  nodes.emplace_back(node7);
  ::primitivNode_t *node8;
  ::primitivNodeSum(nodes[6], 0, &node8);
  nodes.emplace_back(node8);
  ::primitivNode_t *node9;
  ::primitivNodeSum(nodes[7], 1, &node9);
  nodes.emplace_back(node9);
  ::primitivNode_t *node10;
  ::primitivNodeBatchSum(nodes[8], &node10);
